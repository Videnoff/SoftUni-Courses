        ...
        <div class="pad-large">
            <div class="glass narrow">
                <header class="tab layout">
                    <h1 class="tab-item active">
                        Login
                    </h1>
                    <a class="tab-item" href="/register">
                        Register
                    </a>
                </header>
                ...
                <footer class="tab-footer">
                    Don't have an account? <a class="invert" href="/register">
                    Create one here
                </a>.
                </footer>
            </div>
...
export async function loginPage(ctx) {
    ...
    async function onSubmit(event) {
        ...
        const formData = new FormData(event.start);
    ...
    <section id="register">
        <div class="pad-large">
            <div class="glass narrow">
                ...
                <footer class="tab-footer">
                    Already have an account? <a class="invert" href="/login">
                    Sign in here
                </a>.
                </footer>
            </div>
