...
import {getTeamById, editTeam, createTeam} from "../api/data.js";
...
export async function editPage(ctx) {
    ...
    async function populateTemplate() {
        ...
        async function onSubmit(event) {
            ...
            try {
                if (name.length < 4) {
                    throw new Error('Team must be at least 4 characters long.');
                }
                ...
                ctx.render(editTemplate(onSubmit, err.message));
            } finally {
